...
3. Configure a conexão com o banco de dados **PostgreSQL**:
    - Crie um banco de dados chamado `feifood`.
    - Execute o arquivo `FeiFood_DB.sql` para criar as tabelas e inserir dados de exemplo.
...
- Utilizar **JDBC** para conectar Java com o PostgreSQL.
- Criar interfaces gráficas com **Swing**.
- Organizar o código de forma modular utilizando o padrão **MVC**.
- Gerenciar o ciclo de vida de um pedido, incluindo a criação, exibição e avaliação.
